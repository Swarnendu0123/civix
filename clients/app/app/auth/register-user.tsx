  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Alert.alert(
        ...
        `Welcome to Civix, ${name}! You can now start reporting civic issues.`,
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerContent}>
              <IconSymbol name="person.badge.plus.fill" size={48} color="#10B981" />
              <Text style={styles.title}>Register as Citizen</Text>
              <Text style={styles.subtitle}>Join our community and help make your city better</Text>
            </View>
          </View>
